...
#define SSP_SENSOR_TYPE_ACCELEROMETER                    (1)
#define SSP_SENSOR_TYPE_GEOMAGNETIC_FIELD                (2)
#define SSP_SENSOR_TYPE_ORIENTATION                      (3)
#define SSP_SENSOR_TYPE_GYROSCOPE                        (4)
#define SSP_SENSOR_TYPE_LIGHT                            (5)
#define SSP_SENSOR_TYPE_PRESSURE                         (6)
#define SSP_SENSOR_TYPE_TEMPERATURE                      (7) /*Deprecated*/
#define SSP_SENSOR_TYPE_PROXIMITY                        (8)
#define SSP_SENSOR_TYPE_GRAVITY                          (9)
#define SSP_SENSOR_TYPE_LINEAR_ACCELERATION             (10)
#define SSP_SENSOR_TYPE_ROTATION_VECTOR                 (11)
#define SSP_SENSOR_TYPE_RELATIVE_HUMIDITY               (12)
#define SSP_SENSOR_TYPE_AMBIENT_TEMPERATURE             (13)
#define SSP_SENSOR_TYPE_MAGNETIC_FIELD_UNCALIBRATED     (14)
#define SSP_SENSOR_TYPE_GAME_ROTATION_VECTOR            (15)
#define SSP_SENSOR_TYPE_GYROSCOPE_UNCALIBRATED          (16)
#define SSP_SENSOR_TYPE_SIGNIFICANT_MOTION              (17)
#define SSP_SENSOR_TYPE_STEP_DETECTOR                   (18)
#define SSP_SENSOR_TYPE_STEP_COUNTER                    (19)
#define SSP_SENSOR_TYPE_GEOMAGNETIC_ROTATION_VECTOR     (20)
#define SSP_SENSOR_TYPE_HEART_RATE                      (21)
#define SSP_SENSOR_TYPE_TILT_DETECTOR                   (22)
#define SSP_SENSOR_TYPE_WAKE_GESTURE                    (23)
#define SSP_SENSOR_TYPE_GLANCE_GESTURE                  (24)
#define SSP_SENSOR_TYPE_PICK_UP_GESTURE                 (25)
#define SSP_SENSOR_TYPE_WRIST_TILT_GESTURE              (26)
#define SSP_SENSOR_TYPE_META                            (27)

/* Sensor types defined by Samsung */
#define SSP_SENSOR_TYPE_DEVICE_PRIVATE_BASE             (SSP_SENSOR_TYPE_META)
#define SSP_SENSOR_TYPE_ACCELEROMETER_INT               (SSP_SENSOR_TYPE_DEVICE_PRIVATE_BASE + 1)
#define SSP_SENSOR_TYPE_PROXIMITY_RAW                   (SSP_SENSOR_TYPE_DEVICE_PRIVATE_BASE + 2)
#define SSP_SENSOR_TYPE_GEOMAGNETIC_POWER               (SSP_SENSOR_TYPE_DEVICE_PRIVATE_BASE + 3)
#define SSP_SENSOR_TYPE_INTERRUPT_GYRO                  (SSP_SENSOR_TYPE_DEVICE_PRIVATE_BASE + 4)
#define SSP_SENSOR_TYPE_MAX                             (SSP_SENSOR_TYPE_DEVICE_PRIVATE_BASE + 5)
...
struct ssp_data {
	struct sensor_info info[SSP_SENSOR_TYPE_MAX];
	struct sensor_value buf[SSP_SENSOR_TYPE_MAX];
	struct iio_dev *indio_devs[SSP_SENSOR_TYPE_MAX];
	struct iio_chan_spec indio_channels[SSP_SENSOR_TYPE_MAX];
	struct device *devices[SSP_SENSOR_TYPE_MAX];
	...
	int irq;
	int iLibraryLength;
	int aiCheckStatus[SSP_SENSOR_TYPE_MAX];
	...
	int64_t delay[SSP_SENSOR_TYPE_MAX];
	s32 batch_max_latency[SSP_SENSOR_TYPE_MAX];
	s8 batch_opt[SSP_SENSOR_TYPE_MAX];
	u64 latest_timestamp[SSP_SENSOR_TYPE_MAX];
	bool is_data_reported[SSP_SENSOR_TYPE_MAX];
...
/*acc sensor data = raw_data * SSP_ACC_SENSITIVE / SSP_ACC_DIV */
/*acc sensor data = raw_data * (GRAVITY_EARTH / 4096.0f)*/
#define SSP_ACC_SENSITIVE 98
#define SSP_ACC_DIV 40960
/*mag sensor data = raw_data * SSP_MAG_SENSITIVE / SSP_MAG_DIV */
/*mag sensor data = raw_data * (1.0f*0.06f)*/
#define SSP_MAG_SENSITIVE 6
#define SSP_MAG_DIV 100
/*gyro sensor data = raw_data * SSP_GYRO_SENSITIVE / DEGREE_TO_RAD */
/*gyro sensor data = raw_data * ((0.035f) * ((float)PI / 180.0f))*/
#define SSP_GYRO_SENSITIVE 11
#define DEGREE_TO_RAD 18000

#define SSP_ALS_DIV 1
#define SSP_PS_DIV 1
