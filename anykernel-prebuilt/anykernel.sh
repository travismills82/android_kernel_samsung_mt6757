...
write_boot() {
  cd $split_img;
  cmdline="console=null androidboot.hardware=qcom msm_rtb.filter=0x237 ehci-hcd.park=3 androidboot.bootdevice=7824900.sdhci lpm_levels.sleep_disabled=1 earlyprintk androidboot.selinux=permissive";
  board=`cat *-board`;
  base=`cat *-base`;
